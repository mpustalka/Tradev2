...
public function update_language()
{
    ...
    */
    ...
    { 
         ...
         $payeer = $this->input->post('payeer',TRUE);
         $phone = $this->input->post('phone',TRUE);
         $paypal = $this->input->post('paypal',TRUE);
         $stripe = $this->input->post('stripe',TRUE);
         $paystack = $this->input->post('paystack',TRUE);
         $user_id = $this->session->userdata('user_id');

        if($bitcoin!=NULL) {
            $data = array('user_id'=>$user_id,'method'=>$bitcoin,'wallet_id'=>$this->input->post('bitcoin_wallet_id',TRUE));
        ...
        if($payeer!=NULL) {
            ...
            $data = array('user_id'=>$user_id,'method'=>$payeer,'wallet_id'=>$this->input->post('payeer_wallet_id',TRUE));
        ...
        if($phone!=NULL) {
            ...
            $data = array('user_id'=>$user_id,'method'=>$phone,'wallet_id'=>$this->input->post('phone_no',TRUE));
        ...
        if($paypal!=NULL) {
            $data = array('user_id'=>$user_id,'method'=>$paypal,'wallet_id'=>$this->input->post('phone_no',TRUE));
        ...
        if($paystack!=NULL) {
            $data = array('user_id'=>$user_id,'method'=>$paystack,'wallet_id'=>$this->input->post('phone_no',TRUE));
        ...
        if($stripe!=NULL) {
            $data = array('user_id'=>$user_id,'method'=>$stripe,'wallet_id'=>$this->input->post('phone_no',TRUE));
