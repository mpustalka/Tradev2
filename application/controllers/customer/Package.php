                ...
                if($investment > 0 ){
                    ...
                    if(!empty($smsPermission) && $smsPermission->commission == 1){
                        $post = array(
                            ...
                            'message' => 'You received a referral commission of $%amount% . Your new balance is $%new_balance%',
                        );
                    ...
                    $notification = array(
                        ...
                        'details'           => 'You received a referral commission of $'.$commission_amount.'. Your new balance is $'.$new_balance,
