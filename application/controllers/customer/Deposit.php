...
*/
    public function index(){  
        ...
        $this->form_validation->set_rules('amount', display('amount'),'required|numeric|trim|xss_clean');
        $this->form_validation->set_rules('method', display('payment_method'),'required|alpha_numeric|trim|xss_clean');
        $this->form_validation->set_rules('fees', display('fees'),'required|numeric|trim|xss_clean');
