...
class Transfer extends CI_Controller 
{
    ...
    */
    ...
    public function store()
    {
        ...
        $this->form_validation->set_rules('receiver_id', display('receiver_id'), 'required|xss_clean'); 
    ...
    */
    ...
    public function confirm_transfer($id = null)
    {
        ...
        if(!empty($receiverinfo)){
            ...
            $this->session->set_flashdata('exception', "Your Receiver Id Not Match, Please Try Again!");
            redirect('customer/transfer/');
        }
    }
