...
class Testimonial extends CI_Controller {
	...
	{  
        ...
        * Pagination Start
        ******************************/
        $config["base_url"] = base_url('backend/cms/testimonial/index');
	...
	public function form($article_id = null)
	{
		...
		if ($this->form_validation->run()) 
		{
			...
			if (empty($article_id)) 
			{
				...
				redirect("backend/cms/testimonial/form");
			...
			else 
			{
				...
				redirect("backend/cms/testimonial/form/$article_id");
		...
		$data['content'] = $this->load->view("backend/article/testimonial", $data, true);
		$this->load->view("backend/layout/main_wrapper", $data);
	...
	{  
		...
		redirect("backend/cms/testimonial/");
