...
class Slider extends CI_Controller {
	...
	{ 
		...
		$this->form_validation->set_rules('slider_h1_en', display('slider_h1_en'),'required|max_length[1000]|xss_clean');
		...
		$data['slider']   = (object)$sliderdata = array(
			...
			'slider_h1_en'   	=> $this->input->post('slider_h1_en',TRUE),
			'slider_h1_fr' 		=> $this->input->post('slider_h1_fr',TRUE), 
			'slider_h2_en'  	=> $this->input->post('slider_h2_en',TRUE), 
			'slider_h2_fr' 		=> $this->input->post('slider_h2_fr',TRUE),
			'slider_h3_en' 		=> $this->input->post('slider_h3_en',TRUE),
			'slider_h3_fr' 		=> $this->input->post('slider_h3_fr',TRUE),
			'slider_img' 		=> (!empty($image)?$image:$this->input->post('slider_img_old',TRUE)),
