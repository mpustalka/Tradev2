...
class Web_language extends CI_Controller {
	...
	{  
		...
		$this->form_validation->set_rules('name', display('name'),'required|max_length[100]|xss_clean');
		$this->form_validation->set_rules('flag', display('flag'),'required|max_length[10]|xss_clean');
