...
class Home extends CI_Controller 
{
    ...
    public function buy()
    {
        ...
        $this->form_validation->set_rules('cid', display('coin_name'),'required|xss_clean');
        $this->form_validation->set_rules('buy_amount', display('buy_amount'),'required|xss_clean');
        $this->form_validation->set_rules('wallet_id', display('wallet_data'),'required|xss_clean');
        $this->form_validation->set_rules('payment_method', display('payment_method'),'required|xss_clean');
        $this->form_validation->set_rules('usd_amount', display('usd_amount'),'required|xss_clean');
        $this->form_validation->set_rules('rate_coin', display('rate_coin'),'required|xss_clean');
        $this->form_validation->set_rules('local_amount', display('local_amount'),'required|xss_clean');

        if ($this->input->post('payment_method',TRUE)=='bitcoin' || $this->input->post('payment_method',TRUE)=='payeer') {
            $this->form_validation->set_rules('comments', display('comments'),'required|xss_clean');

        }
        if ($this->input->post('payment_method',TRUE)=='phone') {
            $this->form_validation->set_rules('om_name', display('om_name'),'required|xss_clean');
            $this->form_validation->set_rules('om_mobile', display('om_mobile'),'required|xss_clean');
            $this->form_validation->set_rules('transaction_no', display('transaction_no'),'required|xss_clean');
            $this->form_validation->set_rules('idcard_no', display('idcard_no'),'required|xss_clean');
    ...
    public function sells()
    {
        ...
        //Set Rules From validation
        $this->form_validation->set_rules('cid', display('coin_name'),'required|xss_clean');
        $this->form_validation->set_rules('sell_amount', display('sell_amount'),'required|xss_clean');
        $this->form_validation->set_rules('wallet_id', display('wallet_data'),'required|xss_clean');
        $this->form_validation->set_rules('payment_method', display('payment_method'),'required|xss_clean');
        $this->form_validation->set_rules('usd_amount', display('usd_amount'),'required|xss_clean');
        $this->form_validation->set_rules('rate_coin', display('rate_coin'),'required|xss_clean');
        ...
        $data['sell']   = (object)$userdata = array(
            ...
            'coin_amount'           => $this->input->post('sell_amount',TRUE),
            'usd_amount'            => $this->input->post('usd_amount',TRUE),
            'local_amount'          => $this->input->post('local_amount',TRUE),
            'payment_method'        => $this->input->post('payment_method',TRUE),
            'request_ip'            => $this->input->ip_address(),
    ...
    public function register()
    {
        ...
        //Set Rules From validation
        $this->form_validation->set_rules('f_name', display('firstname'),'required|max_length[50]|xss_clean');
        $this->form_validation->set_rules('l_name', display('lastname'),'required|max_length[50]|xss_clean');
        $this->form_validation->set_rules('username', display('username'),'required|max_length[50]|xss_clean');
        $this->form_validation->set_rules('email', display('email'),"required|valid_email|max_length[100]|xss_clean");
        $this->form_validation->set_rules('pass', display('password'),'required|min_length[8]|max_length[32]|matches[r_pass]|xss_clean');
        $this->form_validation->set_rules('r_pass', display('password'),'trim|xss_clean');
        $this->form_validation->set_rules('phone', display('mobile'),'max_length[100]|xss_clean');
        $this->form_validation->set_rules('accept_terms', display('accept_terms_privacy'),'required|xss_clean');
        ...
        if ($this->form_validation->run() === true) {
            ...
            if ($usercheck->num_rows() > 0) {
                ...
                if($this->web_model->registerUser($data)){
                    ...
                    $data['to']         = $this->input->post('email',TRUE);
    ...
    public function login()
    {
        ...
        //Set Rules From validation
        $this->form_validation->set_rules('email', display('email'), 'required|max_length[100]|trim|xss_clean');
    ...
    public function contactMsg()
    {
        ...
        $data['fromName']       = $this->input->post('f_name',TRUE)." ".$this->input->post('l_name',TRUE);
        $data['from']           = $this->input->post('email',TRUE);
        $data['to']             = $appSetting->email;
        $data['subject']        = 'Leave us a message';
        $data['title']          = $this->input->post('email',TRUE);
        $data['message']    = "<b>Phone: </b>".$this->input->post('phone',TRUE)."<br><b>Company: </b>".$this->input->post('company',TRUE)."<br><b>Message: </b>".$this->input->post('comment',TRUE);
    ...
    public function buyPayable()
    {
        ...
        $amount = $this->input->post('buy_amount',TRUE);
    ...
    public function sellPayable()
    {
        ...
        $cid    = $this->input->post('cid',TRUE);
        $amount = $this->input->post('sell_amount',TRUE);
    ...
    public function resetPassword()
    {
        ...
        $this->form_validation->set_rules('newpassword', display('password'),'required|trim|min_length[8]|max_length[32]|matches[r_pass]|xss_clean');
        $this->form_validation->set_rules('r_pass', display('password'),'trim|xss_clean');
