        ...
        if ($method=='bitcoin') {            
            ...
            *********************************/
            if ($gateway) {
                ...
                DEFINE("CRYPTOBOX_PHP_FILES_PATH", base_url('/gourl/lib/'));
                DEFINE("CRYPTOBOX_IMG_FILES_PATH", base_url('gourl/images/'));
                DEFINE("CRYPTOBOX_JS_FILES_PATH", base_url('gourl/js/'));
