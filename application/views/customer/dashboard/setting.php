                    ...
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('backend/dashboard/setting/index','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="footer_text" class="form-control"  placeholder="Footer Text" maxlength="140" rows="7"><?php echo htmlspecialchars_decode($setting->footer_text) ?></textarea>
                                </div>
                            </div>  
