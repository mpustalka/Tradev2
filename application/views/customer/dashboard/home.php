                    ...
                    <div class="form-group">
                        <div class="col-sm-4 award-img">
                           <a href="<?php echo base_url()?>customer/commission/my_level_info"><img src="<?php echo base_url()?>assets/award/0<?php echo html_escape(@$level_info->level); ?>.png"></a>
                        </div>
                    </div>
                    <?php } ?>
                </div>
                <br>
                    ...
                    <div class="social_share">
                        <ul>
                            <li class="whatsapp"><a href="<?php echo base_url()?>customer/commission/my_payout"> <span><?php echo display('my_payout')?> $<?php echo (@$my_earns?number_format(html_escape($my_earns), 2):'0.0');?></span></a></li>
                            <li class="facebook"><a href="<?php echo base_url()?>customer/commission/my_commission"> <span><?php echo display('commission')?> $<?php echo (@$commission?number_format(html_escape($commission), 2):'0.0');?></span></a></li>
                            <li class="twitter"><a href="<?php echo base_url()?>customer/commission/team_bonus"> <span><?php echo display('bonus')?>  $<?php echo ($team_bonus?number_format(html_escape($team_bonus), 2):'0.0');?></span></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="count_panel">
                                ...
                                <h1 class="currency_text text-warning">$<?php echo (@$withdraw!=0?number_format(html_escape($withdraw), 2):'0.0');?></h1>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="count_panel">
                                ...
                                <h1 class="currency_text text-success">$<?php echo (@$team_commission!=0?number_format(html_escape($team_commission), 2):'0.0');?></h1>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="count_panel">
                                ...
                                <h1 class="currency_text text-success">$<?php echo (@$sponser_commission!=0?number_format(html_escape($sponser_commission), 2):'0.0');?></h1>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="count_panel">
                                ...
                                <h1 class="currency_text text-info"> $<?php echo number_format(html_escape($balance), 2);?></h1>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="count_panel">
                                ...
                                <h1 class="currency_text text-info">$<?php echo html_escape($investment->total_amount);?></h1>
                            </div>
                        </div>
                                ...
                                <div class="item">
                                    <div class="pricing__item shadow navy__blue_<?php echo $i++;?>">
                                        ...
                                        <ul class="pricing__feature-list">
                                            <li class="pricing__feature"><?php echo display('period');?> <span><?php echo html_escape($value->period);?> day</span></li>
                                        ...
                                        <table  class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url()?>customer/commission/payout_receipt/<?php echo html_escape($value->earning_id);?>" class="btn btn-success btn-xs">View</a></td>
                                                </tr>
                                                ...
                                                <table  class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><?php echo html_escape(@$info['sponser_info']->username);?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo display('name');?></td>
                                                            <td><?php echo html_escape(@$info['sponser_info']->f_name).' '.html_escape(@$info['sponser_info']->l_name);?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo display('email');?></td>
                                                            <td><?php echo html_escape(@$info['sponser_info']->email);?></td>
                                                        </tr>
                                                         <tr>
                                                            <td><?php echo display('mobile');?></td>
                                                            <td><?php echo html_escape(@$info['sponser_info']->phone);?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table  class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><?php echo display('username');?></td>
                                                    <td><?php echo html_escape($info['my_info']->username);?></td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo display('name');?></td>
                                                    <td><?php echo html_escape($info['my_info']->f_name).' '.html_escape($info['my_info']->l_name);?></td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo display('email');?></td>
                                                    <td><?php echo html_escape($info['my_info']->email);?></td>
                                                </tr>
                                                 <tr>
                                                    <td><?php echo display('mobile');?></td>
                                                    <td><?php echo html_escape($info['my_info']->phone);?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table  class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td><?php echo html_escape($value->f_name).' '.html_escape($value->l_name);?></td>
                                                    <td><?php echo html_escape($value->phone);?></td>
                                                    <td><?php echo html_escape($value->status);?></td>
                                                </tr>
                                                <?php  } }?>
                                            </tbody>
                                        </table>
