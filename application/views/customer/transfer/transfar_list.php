                        ...
                        <table class="datatable2 table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success" href="<?php echo base_url()?>customer/transfer/<?php echo ($value->receiver_user_id==$user_id?'receive_details':'send_details');?>/<?php echo html_escape($value->transfer_id);?>"><?php echo display('details')?></a>
                                    </td>
                                </tr>
                                <?php } } ?>
