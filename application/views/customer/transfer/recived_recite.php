                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo html_escape($send->f_name).' '. html_escape($send->l_name); ?></td>
                            </tr>
                            <tr>
                                <th><?php echo display('email');?></th>
                                <td><?php echo html_escape($send->email); ?></td>
                            </tr>
                            <tr>
                                <th><?php echo display('user_id');?></th>
                                <td><?php echo html_escape($send->user_id); ?></td>
                            </tr>
                            <tr>
                                <th><?php echo display('transfer_amount');?></th>
                                <td>$<?php echo html_escape($send->amount); ?></td>
                            </tr>
