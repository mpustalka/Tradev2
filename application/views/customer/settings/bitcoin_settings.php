                        ...
                        <div class="border_preview">
                            <?php echo form_open('customer/settings/payment_method_update');?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" name="bitcoin_wallet_id" value="<?php echo html_escape(@$bitcoin->wallet_id); ?>" required type="text">
                                    </div>
                                </div>
                        ...
                        <div class="border_preview">
                            <?php echo form_open('customer/settings/payment_method_update');?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" name="payeer_wallet_id" value="<?php echo html_escape(@$payeer->wallet_id); ?>" required type="text">
                                    </div>
                                </div>
                        ...
                        <div class="border_preview">
                            <?php echo form_open('customer/settings/payment_method_update');?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" name="phone_no" value="<?php echo html_escape(@$paypal->wallet_id); ?>" required type="text">
                                    </div>
                                </div>
                        ...
                        <div class="border_preview">
                            <?php echo form_open('customer/settings/payment_method_update');?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" name="phone_no" value="<?php echo html_escape(@$stripe->wallet_id); ?>" required type="text">
                                    </div>
                                </div>
                        ...
                        <div class="border_preview">
                            <?php echo form_open('customer/settings/payment_method_update');?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" name="phone_no" value="<?php echo html_escape(@$phone->wallet_id); ?>" required type="text">
                                    </div>
                                </div>
                        ...
                        <div class="border_preview">
                            <?php echo form_open('customer/settings/payment_method_update');?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" name="phone_no" value="<?php echo html_escape(@$paystack->wallet_id); ?>" required type="text">
                                    </div>
                                </div>
