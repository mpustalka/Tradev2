...
<html lang="en">
    <head>
        ...
        <title><?php echo  display('login') ?> - <?php echo (!empty($settings->title)?html_escape($settings->title):null) ?></title>

        <!-- Favicon and touch icons -->
        <link rel="shortcut icon" href="<?php echo (!empty($settings->favicon)?html_escape($settings->favicon):null) ?>">
                    ...
                    <div class="panel-body">
                        <?php echo form_open('customer','id="loginForm" novalidate'); ?>
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="<?php echo  display('email') ?>" name="email" id="email" class="form-control" value="<?php echo (!empty($user->email)?html_escape($user->email):null) ?>"> 
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="password"><?php echo  display('password') ?></label>
                                <input type="password"  placeholder="<?php echo  display('password') ?>" name="password" id="password" class="form-control" value="<?php echo (!empty($user->email)?html_escape($user->password):null) ?>"> 
                            </div> 
