...
<html lang="en">
	<head>
		...
		<title><?php echo  $settings->title ?> - <?php echo (!empty($title)?html_escape($title):null) ?></title>
						...
						<ul class="nav navbar-nav">
                            ...
                            <li class="dropdown notifications-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="label label-warning"><?php echo html_escape(count($unsen)) ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="header">You have <?php echo html_escape(count($unsen)) ?> notifications</li>
                                    <li>
                                        <ul class="menu">
                                        	<?php foreach($unsen as $val ){?>
                                            <li><a href="<?php echo base_url()?>customer/notification/email_details/<?php echo html_escape($val->notification_id); ?>"><i class="ti-announcement color-green"></i><?php echo html_escape($val->details) ?></a></li>
                                            <?php }?>
                                        </ul>
                                    </li>
