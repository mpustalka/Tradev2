...
?>
                        ...
                        <div class="col-lg-8 offset-lg-2">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">$<?php echo (float)html_escape(@$deposit->fees) ?></td>
                                </tr>
                                <tr>
                                    <th>Total</th>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <th>Total</th>
                                <td class="text-right">$<?php echo html_escape($deposit->deposit_amount+$deposit->fees) ?></td>
                            </tr>
                        </table>
                                ...
                                <td>
                                    ...
                                    <div class="diposit-address margin-top-25">
                                        ...
                                        <div class="deposit-balance margin-top-5">
                                            <h2 class="font-family-inherit">$<?php echo html_escape(number_format($deposit->deposit_amount+(float)@$deposit->fees,8)); ?></span></h2>
                                        </div>
                                    </div>
                                    </center>
                                    ...
                                    <div class="please-note margin-top-10">
                                        ...
                                        <div class="textnote">
                                            <ul>
                                                <li>Coins will be deposited immediately after <font color="#03a9f4"><?php echo html_escape($deposit_data['result']['confirms_needed']);?></font> network confirmations</li>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <center>
                                        <div class="diposit-address margin-top-25">
                                            <div class="label">
                                                <?php echo html_escape($deposit->currency_symbol);?> Deposit Address.
                                            </div>
                                            <div class="dip_address">
                                                <strong><input type="text" id="copyed" value="<?php echo html_escape(@$gateway->public_key) ?>" readonly="readonly"/></strong>
                                            </div>
                                            <div class="copy_address margin-top-10">
                                            ...
                                            <div class="diposit-qrcode margin-top-25">
                                                <div class="qrcode">
                                                    <img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=<?php echo html_escape(@$gateway->public_key) ?>&choe=UTF-8" />
                                                </div>
                                            </div>
                                            <?php } ?>
                                        </div>
                                        <p class="font-size-22">$<?php echo html_escape($deposit->deposit_amount+(float)@$deposit->fees) ?></p>
                                    </center>
                        ...
                        <?php } elseif ($deposit->deposit_method=='stripe')  { ?>
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Total</th>
                                    <td class="text-right">$<?php echo html_escape($deposit->deposit_amount+(float)@$deposit->fees) ?></td>
                                </tr>
                            </table>
                            <?php echo form_open('payment_callback/stripe_confirm', 'method="post" '); ?>
                            <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="<?php echo html_escape($deposit_data['stripe']['publishable_key']); ?>" data-description="<?php echo html_escape($deposit_data['description']) ?>" data-amount="<?php $total = $deposit->deposit_amount+$deposit->fees; echo html_escape(round($total*100)) ?>" data-locale="auto">
                            </script>
                        <?php echo form_close();?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <input name="total" type="text" class="form-control" id="total" value="<?php echo html_escape(@$deposit->deposit_method+@$deposit->fees) ?>" required readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
