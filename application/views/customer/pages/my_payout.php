                        ...
                        <table  class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url()?>customer/commission/payout_receipt/<?php echo html_escape($value->earning_id);?>" class="btn btn-success btn-xs"><?php echo display('view')?></a></td>
                                </tr>
