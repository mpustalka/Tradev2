    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('uid', html_escape($profile->uid)) ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" value="<?php echo html_escape($profile->sponsor_id) ?>" class="form-control" name="sponsor_id" placeholder="<?php echo display("sponsor_name") ?>" disabled>
                        </div>

                        <div class="form-group col-lg-6">
                            <label><?php echo display("firstname") ?> *</label>
                            <input type="text" value="<?php echo html_escape($profile->f_name) ?>" class="form-control" name="f_name" placeholder="<?php echo display("firstname") ?>">
                        </div>

                        <div class="form-group col-lg-6">
                            <label><?php echo display("lastname") ?> *</label>
                            <input type="text" value="<?php echo html_escape($profile->l_name) ?>" class="form-control" name="l_name" placeholder="<?php echo display("lastname") ?>">
                        </div>

                        <div class="form-group col-lg-6">
                            <label><?php echo display("email") ?> *</label>
                            <input type="text" value="<?php echo html_escape($profile->email) ?>" class="form-control" name="email" placeholder="<?php echo display("email") ?>">
                        </div>
