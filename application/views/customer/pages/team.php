                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo html_escape($level_one['user_id_'.$i]); ?></td>
                                                <td><?php echo html_escape($level_one['username_'.$i]); ?></td>
                                                <td><?php echo html_escape($level_one['name_'.$i]); ?></td>
                                                <td><?php echo html_escape($value1->order_id); ?></td>
                                                <td><?php echo html_escape($value1->amount); ?></td>
                                            </tr>
                                            <?php } } ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo html_escape($level_two['user_id_'.$i]); ?></td>
                                                <td><?php echo html_escape($level_two['username_'.$i]); ?></td>
                                                <td><?php echo html_escape($level_two['name_'.$i]); ?></td>
                                                <td><?php echo html_escape($value2->order_id); ?></td>
                                                <td><?php echo html_escape($value2->amount); ?></td>
                                            </tr>
                                            <?php } } ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo html_escape($level_three['user_id_'.$i]); ?></td>
                                                <td><?php echo html_escape($level_three['username_'.$i]); ?></td>
                                                <td><?php echo html_escape($level_three['name_'.$i]); ?></td>
                                                <td><?php echo html_escape($value3->order_id); ?></td>
                                                <td><?php echo html_escape($value3->amount); ?></td>
                                            </tr>
                                            <?php } } ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo html_escape($level_four['user_id_'.$i]); ?></td>
                                                <td><?php echo html_escape($level_four['username_'.$i]); ?></td>
                                                <td><?php echo html_escape($level_four['name_'.$i]); ?></td>
                                                <td><?php echo html_escape($value4->order_id); ?></td>
                                                <td><?php echo html_escape($value4->amount); ?></td>
                                            </tr>
                                            <?php } } ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo html_escape($level_five['user_id_'.$i]); ?></td>
                                                <td><?php echo html_escape($level_five['username_'.$i]); ?></td>
                                                <td><?php echo html_escape($level_five['name_'.$i]); ?></td>
                                                <td><?php echo html_escape($value5->order_id); ?></td>
                                                <td><?php echo html_escape($value5->amount); ?></td>
                                            </tr>
                                            <?php } } ?>
