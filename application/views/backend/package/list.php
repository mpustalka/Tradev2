                ...
                <table class="datatable2 table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo html_escape($value->package_amount); ?></td>
                            <td><?php echo html_escape($value->daily_roi); ?></td>
                            <td><?php echo html_escape($value->weekly_roi); ?></td>
                            <td><?php echo html_escape($value->monthly_roi); ?></td>
                            <td><?php echo html_escape($value->yearly_roi); ?></td>
                            <td><?php echo html_escape($value->total_percent); ?></td>
