            ...
            <div class="panel-body">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <?php echo html_escape($user->username) ?></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="cid" class="col-sm-4 col-form-label"><?php echo display('sponsor_id') ?></label>
                        <div class="col-sm-8">
                            <?php echo html_escape($user->sponsor_id) ?></span>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <?php echo html_escape($user->reg_ip) ?></span>
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo html_escape($sl++); ?></td>
                                <td><?php echo html_escape($value->sponsor_id); ?></td>
