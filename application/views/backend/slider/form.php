    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('slider_id', html_escape($slider->slider_id)) ?> 
                    ...
                    <div class="form-group row">
                        <label for="slider_h1_fr" class="col-sm-4 col-form-label"><?php echo display('slider_h1')." ".html_escape($web_language->name) ?></label>
                        <div class="col-sm-8">
                            <input name="slider_h1_fr" value="<?php echo htmlspecialchars_decode($slider->slider_h1_fr) ?>" class="form-control" type="text" id="slider_h1_fr">
                        </div>
                    </div> 
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="slider_h2_fr" class="col-sm-4 col-form-label"><?php echo display('slider_h2')." ".html_escape($web_language->name) ?></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="slider_h3_fr" class="col-sm-4 col-form-label"><?php echo display('slider_h3')." ".html_escape($web_language->name) ?></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="custom_url" value="<?php echo html_escape($slider->custom_url); ?>" class="form-control" type="text" id="custom_url">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="hidden" name="slider_img_old" value="<?php echo html_escape($slider->slider_img) ?>">
                            <span  class="mention-text">1349x750 px(jpg, jpeg, png)</span>
                            <?php if (!empty($slider->slider_img)) { ?>
                                <img src="<?php echo base_url().html_escape($slider->slider_img) ?>" width="450">
                            <?php } ?>                            
                        </div>
                    </div>
                    <div class="form-group row">
