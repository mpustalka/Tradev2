                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <?php echo form_hidden('id', html_escape($language->id)) ?> 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="flag" value="<?php echo strtolower(html_escape($language->flag)) ?>" class="form-control" placeholder="<?php echo display('for_flag_use_country_code_bellow_table') ?>" type="text" id="flag">
                            </div>
                        </div>
                        <div class="row">
                ...
                <table class="datatable2 table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo strtolower(html_escape($key)); ?></td>
                            <td><?php echo ucwords(strtolower(html_escape($value['name']))); ?></td>
                        </tr>
                        <?php } ?>  
                    </tbody>
                </table>
