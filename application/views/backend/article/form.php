            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', html_escape($article->article_id)) ?> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input name="article_image" class="form-control" placeholder="<?php echo display('image') ?>" type="file" id="article_image">
                             ...
                             <?php } ?>
                             <span  class="mention-text">300x312 px(jpg, jpeg, png, gif, ico)</span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="video" class="col-sm-2 col-form-label"><?php echo display('video') ?></label>
                        <div class="col-sm-10">
                            <input name="video" value="<?php echo html_escape($article->video) ?>" class="form-control" placeholder="<?php echo display('video') ?>" type="text" id="video">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea   id="summernote1" name="article1_fr" class="form-control" placeholder="<?php echo display('article')." ".html_escape($web_language->name) ?>" type="text" id="article1_fr"><?php echo htmlspecialchars($article->article1_fr) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="article2_fr" class="col-sm-2 col-form-label"><?php echo display('article')." ".html_escape($web_language->name) ?></label>
                        <div class="col-sm-10">
                            <textarea   id="summernote3" name="article2_fr" class="form-control" placeholder="<?php echo display('article')." ".html_escape($web_language->name) ?>" type="text" id="article2_fr"><?php echo htmlspecialchars($article->article2_fr) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
