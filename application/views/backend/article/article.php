        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', html_escape($article->article_id)) ?> 
                    ...
                    <div class="form-group row">
                        <label for="headline_fr" class="col-sm-2 col-form-label"><?php echo display('headline')." ".html_escape($web_language->name) ?><i class="text-danger">*</i></label>
                        <div class="col-sm-10">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control basic-single" name="cat_id">
                                ...
                                <?php foreach ($parent_cat as $key => $value) { ?>
                                    <option value="<?php echo html_escape($value->cat_id); ?>" <?php echo ($article->cat_id==$value->cat_id)?'Selected':'' ?>><?php echo html_escape($value->cat_name_en); ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
