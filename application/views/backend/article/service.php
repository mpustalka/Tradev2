            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', html_escape($article->article_id)) ?> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="article1_fr" class="form-control" placeholder="<?php echo display('short_description')." ".html_escape($web_language->name) ?>" type="text" id="article1_fr"><?php echo htmlspecialchars($article->article1_fr) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea   id="summernote1" name="article2_fr" class="form-control" placeholder="<?php echo display('long_description')." ".html_escape($web_language->name) ?>" type="text" id="article2_fr"><?php echo htmlspecialchars($article->article2_fr) ?></textarea>
                        </div>
                    </div>
                    <div class="row">
