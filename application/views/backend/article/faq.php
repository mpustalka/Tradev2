        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', html_escape($article->article_id)) ?> 
                    ...
                    <div class="form-group row">
                        <label for="headline_fr" class="col-sm-2 col-form-label"><?php echo display('question')." ".html_escape($web_language->name) ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="article1_fr" class="col-sm-2 col-form-label"><?php echo display('answer')." ".html_escape($web_language->name) ?></label>
                        <div class="col-sm-10">
