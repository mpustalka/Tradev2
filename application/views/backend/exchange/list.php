                ...
                <table class="datatable2 table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    foreach ($currency as $ckey => $cvalue) {
                                         echo ($value->coin_id==$cvalue->cid)?html_escape($cvalue->name):'';
                                    }
                                ?>
                            </td>
                            <td>
                                <?php 
                                    foreach ($userinfo as $ukey => $uvalue) {
                                        echo ($value->user_id==$uvalue->user_id)?html_escape($uvalue->f_name)." ".html_escape($uvalue->l_name):'';
                                    }
                                ?>
                            </td>
                            <td><?php echo html_escape($value->coin_wallet_id); ?></td>
                            <td><?php echo html_escape($value->transection_type); ?></td>
                            ...
                            <td><?php echo html_escape($value->payment_method); ?></td>
