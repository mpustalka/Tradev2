...
<html lang="en">
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <link href="https://fonts.googleapis.com/css?family=Alegreya+Sans:100,100i,300,300i,400,400i,500,500i,700,700i,800,800i,900,900i" rel="stylesheet" type="text/css"/>
            ...
            <aside class="main-sidebar">
                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(3) == "exchange" ||$this->uri->segment(3) == "currency" ||$this->uri->segment(3) == "local_currency" ||$this->uri->segment(3) == "exchange_wallet")? "active" : null) ?>">
                            <a href="#">
