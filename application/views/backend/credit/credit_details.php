            ...
            <div class="panel-body"  id="printableArea">
                <div class="row">
                    ...
                    <div class="col-sm-6 text-right">
                        ...
                        <address>
                            <strong><?php echo html_escape(@$credit_info->f_name).' '.html_escape(@$credit_info->l_name);?></strong><br>
                ...
                <div class="table-responsive m-b-20">
                    <table class="table table-border table-bordered ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>$<?php echo html_escape(@$credit_info->deposit_amount);?></td>
                                <td><?php echo html_escape(@$credit_info->deposit_date);?></td>
                                <td><?php echo html_escape(@$credit_info->comments);?></td>
                            </tr>
                    ...
                    <?php 
                        if (!@$credit_info->user_id) {
                            echo "<h1 class='not-found'>User Not Found !!!</h1>";
                        }  
                    ?>                 
                </div>
            </div>
