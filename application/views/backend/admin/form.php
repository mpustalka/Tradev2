            ...
            <div class="panel-body">
                <?php echo form_open_multipart("backend/dashboard/admin/form/$admin->id") ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea name="about" placeholder="<?php echo display('about') ?>" class="form-control" id="about"><?php echo htmlspecialchars_decode($admin->about) ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <?php if (!empty($admin->image)) { ?>
                               <img src="<?php echo base_url(htmlspecialchars_decode($admin->image)) ?>" class="img-thumbnail" width="125" height="100">
                            <?php } ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span  class="mention-text">51x38 px(jpg, jpeg, png, gif, ico)</span>
                        </div>
                    </div> 
