                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="count_panel panel-navy-blue">
                                ...
                                <h1 class="currency_text "><?php echo (@$total_user?html_escape($total_user):'0'); ?></h1>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="count_panel panel-orenge">
                                ...
                                <h1 class="currency_text">$<?php echo (@$total_roi?number_format(html_escape($total_roi), 2):'0.0');?></h1>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="count_panel panel-blue">
                                ...
                                <h1 class="currency_text">$<?php echo (@$commission?number_format(html_escape($commission), 2):'0.0');?></h1>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="count_panel panel-sky">
                                ...
                                <h1 class="currency_text">$<?php echo (@$total_investment?number_format(html_escape($total_investment), 2):'0.0');?></h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <tbody>
                            <?php 
                                foreach ($exchange as $key => $value) { ?>
                                    ...
                                    <td><?php echo html_escape($value->transection_type); ?> - 
                                        <?php foreach ($cryptocurrency as $keyc => $valuec) {
                                            if ($value->coin_id==$valuec->cid) {
                                               echo html_escape($valuec->symbol);
                                            }
                                        } ?>
                                        </td>
                    ...
                    <table  class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo html_escape($value->request_ip); ?></td>
                                <td><?php echo html_escape($value->amount); ?></td>
                               
                                 <td>
                                     <a href="<?php echo base_url()?>backend/withdraw/withdraw/confirm_withdraw?id=<?php echo html_escape($value->withdraw_id);?>&user_id=<?php echo html_escape($value->user_id);?>&set_status=2" class="btn btn-warning btn-sm"><?php echo display('confirm')?></a>
                                     <a href="<?php echo base_url()?>backend/withdraw/withdraw/cancel_withdraw?id=<?php echo html_escape($value->withdraw_id);?>&user_id=<?php echo html_escape($value->user_id);?>&set_status=3" class="btn btn-danger btn-sm"><?php echo display('cancel')?></a>
                                     
                                     <a href="#<?php echo html_escape($value->user_id);?>" class="AjaxModal btn btn-info btn-sm" data-toggle="modal" data-target="#newModal"> Information</a>
                                 </td>
