                    ...
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('backend/dashboard/setting/index','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="phone" type="text" class="form-control" id="phone" placeholder="<?php echo display('phone') ?>"  value="<?php echo html_escape($setting->phone) ?>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    ...
                                    <span  class="mention-text">32x32 px(jpg, jpeg, png, gif, ico)</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    ...
                                    <span  class="mention-text">184x42 px(jpg, jpeg, png, gif, ico)</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    ...
                                    <span class="mention-text">163x50 px(jpg, jpeg, png, gif, ico)</span>
                                </div>
                            </div>
