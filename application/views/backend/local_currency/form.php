    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('currency_id', html_escape($local_currency->currency_id)) ?> 
                    <div class="form-group row">
                        <label for="currency_name" class="col-sm-4 col-form-label"><?php echo display('currency_name') ?></label>
                        <div class="col-sm-8">
                            <input name="currency_name" value="<?php echo html_escape($local_currency->currency_name) ?>" class="form-control" type="text" id="currency_name">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="currency_iso_code" class="col-sm-4 col-form-label"><?php echo display('currency_iso_code') ?></label>
                        <div class="col-sm-8">
                            <input name="currency_iso_code" value="<?php echo html_escape($local_currency->currency_iso_code) ?>" class="form-control" type="text" id="currency_iso_code">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="usd_exchange_rate" class="col-sm-4 col-form-label"><?php echo display('usd_exchange_rate') ?></label>
                        <div class="col-sm-8">
                            <input name="usd_exchange_rate" value="<?php echo html_escape($local_currency->usd_exchange_rate) ?>" class="form-control" type="text" id="usd_exchange_rate">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="currency_symbol" class="col-sm-4 col-form-label"><?php echo display('currency_symbol') ?></label>
                        <div class="col-sm-8">
                            <input name="currency_symbol" value="<?php echo html_escape($local_currency->currency_symbol) ?>" class="form-control" type="text" id="currency_symbol">
                        </div>
                    </div> 
                    <div class="form-group row">
