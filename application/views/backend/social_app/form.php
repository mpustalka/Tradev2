    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        <input type="text" class="form-control" id="copyed1" value="<?php echo base_url(($social_app->agent=='Facebook')?'user_authentication/fblogin':'user_authentication/glogin'); ?>" readonly>
            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('id', html_escape($social_app->id)) ?>
                    <?php if ($social_app->agent!=='reCAPTCHA') { ?>
                    <div class="form-group row">
                        <label for="app_id" class="col-sm-4 col-form-label"><?php echo display('app_id') ?></label>
                        <div class="col-sm-8">
                            <input name="app_id" value="<?php echo html_escape($social_app->app_id) ?>" class="form-control" type="text" id="app_id">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="app_secret" class="col-sm-4 col-form-label"><?php echo display('app_secret') ?></label>
                        <div class="col-sm-8">
                            <input name="app_secret" value="<?php echo html_escape($social_app->app_secret) ?>" class="form-control" type="text" id="app_secret">
                        </div>
                    </div> 
                    <?php } ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="api_key" value="<?php echo html_escape($social_app->api_key) ?>" class="form-control" type="text" id="api_key">
                        </div>
                    </div>
                    <?php } ?>
                    <?php if ($social_app->agent=='reCAPTCHA') { ?>
