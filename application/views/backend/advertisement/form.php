    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('id', html_escape($advertisement->id)) ?> 
                        ...
                        <div class="col-sm-8">
                            <select class="form-control basic-single" name="page">
                                ...
                                <?php foreach ($parent_cat as $key => $value) { ?>
                                    <option value="<?php echo html_escape($value->cat_id); ?>" <?php echo ($advertisement->page==$value->cat_id)?'Selected':'' ?>><?php echo htmlspecialchars_decode($value->cat_name_en); ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <span id="add_content_load">
                        ...
                        <div class='form-group row'>
                            ...
                            <div class='col-sm-8'>
                                ...
                                <input type='hidden' name='image_old' value='<?php echo html_escape($advertisement->image) ?>'><?php if(!empty($advertisement->image)){ ?>
                                <img src='<?php echo base_url(html_escape($advertisement->image)) ?>' width='450'><?php } ?>
                            </div>
                        </div>
                        <div class='form-group row'>
                            <label for='url' class='col-sm-4 col-form-label'><?php echo display('url') ?></label>
                            <div class='col-sm-8'>
                                <input name='url' value='<?php echo htmlspecialchars_decode($advertisement->url) ?>' class='form-control' placeholder='<?php echo display('url') ?>' type='text' id='url'>
                            </div>
                        </div>
                        <?php } ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="serial_position" value="<?php echo html_escape($advertisement->serial_position) ?>" class="form-control" placeholder="<?php echo display('position_serial') ?>" type="text" id="serial_position">
                        </div>
                    </div>
                    <div class="form-group row">
