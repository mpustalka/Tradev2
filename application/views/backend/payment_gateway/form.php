            ...
            <div class="panel-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group col-sm-8">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-primary copy2" type="button">Copy</button>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <?php echo form_hidden('id', html_escape($payment_gateway->id)) ?> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input name="public_key" value="<?php echo html_escape($payment_gateway->public_key) ?>" class="form-control" type="text" id="public_key" required>
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="private_key" class="col-sm-4 col-form-label"><?php echo html_escape($level2); ?> <i class="text-danger">*</i></label>
                        <div class="col-sm-6">
                            <input name="private_key" value="<?php echo html_escape($payment_gateway->private_key) ?>" class="form-control" type="text" id="private_key" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input name="shop_id" value="<?php echo html_escape($payment_gateway->shop_id) ?>" class="form-control" type="text" id="shop_id" required>
                        </div>
                        <div class='col-sm-2'>
