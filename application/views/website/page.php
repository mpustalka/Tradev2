        ...
        <div class="about_content">
            <div class="container">
                <div class="row about-text justify-content">
                    <div class="col-md-12">
                        <h1><?php echo html_escape($headline); ?></h1>
                        <img src="<?php echo base_url(html_escape($article_image)); ?>" alt="<?php echo strip_tags(html_escape($headline)); ?>">
                        <?php echo htmlspecialchars_decode($article1); ?>
                        <?php echo htmlspecialchars_decode($article2); ?>
                    </div>
                </div>
            </div>
        </div>
