                ...
                <div class="col-sm-7 col-md-6">
                    <div class="">
                        <ul class="nav nav-tabs">
                            <li id="btntab1" class="active"><a href="#tab1" data-toggle="tab"><?php echo display('register') ?></a></li>
                            <li id="btntab2"><a href="#tab2" data-toggle="tab"><?php echo display('login') ?></a></li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <?php echo form_open('register','id="registerForm" name="registerForm"'); ?>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input">
                                            <select  class="selectpicker" data-width="100%" class="country input__field" id="country" name="country">
                                                <option value="" selected><?php echo display('select_country'); ?></option>
                                                <?php
                                                    foreach($countryArray as $code => $country){
                                                        $countryName = ucwords(strtolower($country["name"]));
                                                ?>
                                                <option value="<?php echo html_escape($country["code"]) ?>"><?php echo html_escape($countryName)." (+".html_escape($country["code"]).")"?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>    
                                ...
                                <div class="row">    
                                    <div class="col-sm-12">
                                        <div class="input">
                                            <input class="input__field" type="email" id="email" name="email" id="email" value="<?php if(!empty($this->session->userData['email'])) echo $this->session->userData['email']; ?>" autocomplete="off" required>
                                ...
                                <div class="row">    
                                    <div class="col-sm-12">
                                        <div class="input">
                                            <input class="input__field" type="password" name="pass" id="pass" required>
                                ...
                                <div class="row">    
                                    <div class="col-sm-12">
                                        <div class="input">
                                            <input class="input__field" type="password" name="r_pass" id="r_pass" required>
                                ...
                                <div class="row">    
                                    <div class="col-sm-12">
                                        <div class="input">
                                            ...
                                            <?php echo display('your_password_at_global_crypto_are_encrypted_and_secured'); ?> <a target="_blank" href="<?php echo base_url(html_escape(@$article_image[0])); ?>" class="checkbox-link"><?php echo display('privacy_policy'); ?></a> <?php echo display('and'); ?> 
                                                <a target="_blank" href="<?php echo base_url(html_escape((@$article_image[0]))); ?>" class="checkbox-link"><?php echo display('terms_of_use'); ?></a>
                                        </div>
                                    </div>
                                </div>
