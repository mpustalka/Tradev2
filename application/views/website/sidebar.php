...
?>
                        <div class="post post_list post_list_sm">
                            <div class="post_img">
                                <a href="<?php echo base_url($this->uri->segment(1).'/'.html_escape($cat_slug->slug)."/$slug"); ?>"><img src="<?php echo base_url(html_escape($news_article_image)); ?>" alt="<?php echo strip_tags(html_escape($news_headline)); ?>"></a>
                            </div>
                            <div class="post_body">
                                <h4 class="post_heading"><a href="<?php echo base_url($this->uri->segment(1).'/'.html_escape($cat_slug->slug)."/$slug"); ?>"><?php echo strip_tags(html_escape($news_headline)); ?></a></h4>
                                <div class="post_meta">
...
<?php } ?>
                        ...
                        <div class="widget">
                            ...
                            <div class="social_icon">
                                <?php foreach ($social_link as $key => $value) { ?>
                                    <a href="<?php echo html_escape($value->link); ?>" class="<?php echo html_escape($value->icon); ?>"><i class="fa fa-<?php echo html_escape($value->icon); ?>"></i></a>
                                <?php } ?>
                            </div>
                        ...
                        <div class="widget">
                            ...
                            <ul class="widget_category">
                                ...
                                ?>
                                    <li><a href="<?php echo base_url("news/$newscatslug") ?>"><span>#</span><?php echo html_escape($newscatname_list) ?></a></li>
                                <?php
                                    }
                                ?>
                            </ul>
