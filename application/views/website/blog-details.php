                        ...
                        <div class="col-sm-8 col-sm-offset-2">
                            <div class="haeder-text">
                                <h1><?php echo htmlspecialchars_decode($cat_title1); ?></h1>
                                    <?php echo htmlspecialchars_decode($cat_title2); ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <main class="col-sm-8">
                        ...
                        <div class="post_details">
                            ...
                            <figure>
                                <img src="<?php echo base_url(html_escape($news_article_image)); ?>" alt="<?php echo strip_tags(html_escape($news_headline)); ?>" class="aligncenter img-responsive col-sm-12">
                            </figure>
