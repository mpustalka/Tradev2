                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="form-content">
                            <?php echo form_open_multipart("sells",'id="sellform"  class="form-horizontal" name="sellform"'); ?>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label"><?php echo display('your') ?> <i></i> <?php echo display("wallet_data") ?></label>
                                    <div class="col-sm-8">
                                        <input name="wallet_id" class="form-control" type="text" id="wallet_id" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label"><?php echo display('company') ?> <i></i> <?php echo display("wallet_data") ?></label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-8">
                                        ...
                                        <a  class="btn btn-orange" href="<?php echo base_url()?>"><?php echo display("cancel") ?></a>
                                    </div>
                                </div>
                            <?php echo form_close() ?>
