                ...
                <div class="row about-text justify-content">
                    <div class="col-md-6">
                        <div class="about-info">
                            <h2><?php echo htmlspecialchars_decode(@$headline[0]); ?></h2>
                            <div class="definition"><?php echo htmlspecialchars_decode(@$article1[0]); ?></div>
                            <?php echo htmlspecialchars_decode(@$article2[0]); ?>
                            <a href="<?php echo base_url("contact"); ?>" class="btn btn-default mr-20 mb-10"><?php echo display('contact_us'); ?></a>
                            <div class="play-button">
                                <a href="<?php echo html_escape(@$article_video[0]); ?>" class="btn-play popup-youtube">
                    ...
                    <div class="col-md-6">
                        <div class="text-right">
                            <img src="<?php echo base_url(html_escape(@$article_image[1])); ?>" class="img-responsive" alt="<?php echo strip_tags(htmlspecialchars_decode(@$headline[1])); ?>">
                        </div>
                        <div class="quote">
                            <?php echo @$article1[1]; ?>
                            <div class="author-address"><?php echo htmlspecialchars_decode(@$headline[1]); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4">
                        <section class="title_content">
                            <h2 class="content__title"><?php echo htmlspecialchars_decode(@$headline[2]); ?></h2>
                            <p class="content__description"><?php echo htmlspecialchars_decode(@$article1[2]); ?></p>
                        </section>
                    </div>
...
?>
                            <div class="col-sm-4 team">
                                <h2 class="team__number">0<?php echo html_escape($position_serial); ?></h2>
                                <div class="team__member">
                                    <a href="#" class="team__member__img" style="background-image: url(<?php echo base_url(html_escape($tea_article_image)); ?>)"></a>
                                </div>
                                <div class="member__detail">
                                    <a href="#" class="member__title"><h4><?php echo htmlspecialchars_decode($tea_headline); ?></h4></a>
                                    <p class="member__description"><?php echo htmlspecialchars_decode($tea_article1); ?></p>
                                </div>
                            </div>
                            <!-- /.End of team -->
<?php
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="section_title">
                            <h3><?php echo htmlspecialchars_decode(@$headline[3]); ?></h3>
                            <?php echo htmlspecialchars_decode(@$article1[3]); ?>
                        </div>
                    </div>
                </div>
                <div class="row">
...
?>
                            <div class="logo-item">
                                <a href="<?php echo htmlspecialchars_decode($cli_article1); ?>" target="_blank"><img src="<?php echo base_url(html_escape($cli_article_image)); ?>" class="img-responsive" alt="<?php echo strip_tags(html_escape($cli_headline)); ?>"></a>
                            </div>
<?php
