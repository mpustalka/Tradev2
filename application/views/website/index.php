...
<div class="animation-slide owl-carousel owl-theme" id="animation-slide">
    ...
    ?>
        <?php if ($i==0) { ?>
            <!-- Slide 1-->
            <div class="item slide-one" style="background-image: url(<?php echo base_url(html_escape($value->slider_img)); ?>)">
        ...
        <?php } elseif ($i==1) { ?>
            <!-- Slide 2-->
            <div class="item slide-two" style="background-image: url(<?php echo base_url(html_escape($value->slider_img)); ?>)">
                <div class="slide-table">
                    <div class="slide-tablecell">
                        <div class="container">
                            <div class="row">
        ...
        <?php } else { ?>
            <!-- Slide 3-->
            <div class="item slide-three" style="background-image: url(<?php echo base_url(html_escape($value->slider_img)); ?>)">
                <div class="slide-table">
                    <div class="slide-tablecell">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide-text text-right">
                                        ...
                                        <p><?php echo htmlspecialchars_decode($slide_h2); ?></p>
                                        <div class="slide-buttons">
                                            <a href="<?php echo html_escape($custom_url); ?>" class="slide-btn"><?php echo htmlspecialchars_decode($slide_h3); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="list-wrpaaer">
            <ul id="marquee-horizontal">
                <?php foreach ($cryptocoins as $coin_key => $coin_value) {?>
                    <li class="list-item" id="<?php echo html_escape($coin_value->Symbol) ?>">
                        <div class="list-item-currency"><?php echo html_escape($coin_value->Symbol) ?></div>
            ...
            <div class="row about-text justify-content">
                <div class="col-md-6">
                    <div class="about-info">
                        ...
                        <div class="play-button">
                            <a href="<?php echo html_escape(@$abo_article_video[0]); ?>" class="btn-play popup-youtube">
                ...
                <div class="col-md-6">
                    <div class="text-right">
                        <img src="<?php echo base_url(html_escape(@$abo_article_image[1])); ?>" class="img-responsive" alt="<?php echo strip_tags(htmlspecialchars_decode(@$abo_headline[1])); ?>">
                    </div>
                    <div class="quote">
                        <?php echo html_escape(substr($abo_article1[1],0,130)); ?>
            ...
            <div class="row justify-content">
                <div class="col-sm-4">
                    <div class="bitcoin-sack">
                        <img src="<?php echo base_url(html_escape(@$hom_article_image[0])); ?>" class="img-responsive center-block" alt="<?php echo strip_tags(htmlspecialchars_decode(@$hom_headline[0])); ?>">
                    </div>
                </div>
                <div class="col-sm-8">
                            ...
                            <div class="input-group">
                                <div class="input-group-btn">
                                    <select class="selectpicker convertfromcryptolist" id="convertfromcryptolist" data-width="80px" name="convertfromcryptolist">                                            
                                        <?php foreach ($cryptocoins as $coin_key => $coin_value) { ?>
                                            <option value="<?php echo html_escape($coin_value->Symbol); ?>"><?php echo html_escape($coin_value->Name); ?></option>
                                        <?php } ?>
                            ...
                            <div class="input-group">
                                <div class="input-group-btn">
                                    <select class="selectpicker converttocryptolist" id="converttocryptolist" data-width="80px" name="converttocryptolist">
                                        ...
                                        <?php foreach ($cryptocoins as $coin_key => $coin_value) { ?>
                                            <option <?php echo $coin_value->Symbol=='USD'?'selected':NULL ?> value="<?php echo html_escape($coin_value->Symbol); ?>"><?php echo html_escape($coin_value->Name); ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
        ...
        <div class="container">
            ...
            <div class="col-sm-3">
                <div class="feature__box">
                    <i class="<?php echo html_escape(@$ser_icon[0]); ?>"></i>
                    <div class="feature__content">
                        <h3><a href="<?php echo base_url("service/".html_escape(@$ser_slug[0])) ?>"><?php echo htmlspecialchars_decode(@$ser_headline[0]); ?></a></h3>
            ...
            <div class="col-sm-3">
                <div class="feature__box">
                    <i class="<?php echo html_escape(@$ser_icon[1]); ?>"></i>
                    <div class="feature__content">
                        <h3><a href="<?php echo base_url("service/".html_escape(@$ser_slug[1])) ?>"><?php echo htmlspecialchars_decode(@$ser_headline[1]); ?></a></h3>
            ...
            <div class="col-sm-3">
                <div class="feature__box">
                    <i class="<?php echo html_escape(@$ser_icon[2]); ?>"></i>
                    <div class="feature__content">
                        <h3><a href="<?php echo base_url("service/".html_escape(@$ser_slug[2])) ?>"><?php echo html_escape(@$ser_headline[2]); ?></a></h3>
                        <p><?php echo html_escape(@$ser_article1[2]); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="feature__box">
                    <i class="<?php echo html_escape(@$ser_icon[3]); ?>"></i>
                    <div class="feature__content">
                        <h3><a href="<?php echo base_url("service/".html_escape(@$ser_slug[3])) ?>"><?php echo html_escape(@$ser_headline[3]); ?></a></h3>
            ...
            <div class="col-sm-3">
                <div class="feature__box">
                    <i class="<?php echo html_escape(@$ser_icon[4]); ?>"></i>
                    <div class="feature__content">
                        <h3><a href="<?php echo base_url("service/".html_escape(@$ser_slug[4])) ?>"><?php echo html_escape(@$ser_headline[4]); ?></a></h3>
            ...
            <div class="col-sm-3">
                <div class="feature__box">
                    <i class="<?php echo html_escape(@$ser_icon[5]); ?>"></i>
                    <div class="feature__content">
                        <h3><a href="<?php echo base_url("service/".html_escape(@$ser_slug[5])) ?>"><?php echo html_escape(@$ser_headline[5]); ?></a></h3>
            ...
            <div class="col-sm-3">
                <div class="feature__box">
                    <i class="<?php echo html_escape(@$ser_icon[6]); ?>"></i>
                    <div class="feature__content">
                        <h3><a href="<?php echo base_url("service/".html_escape(@$ser_slug[6])) ?>"><?php echo html_escape(@$ser_headline[6]); ?></a></h3>
            ...
            <div class="col-sm-3">
                <div class="feature__box">
                    <i class="<?php echo html_escape(@$ser_icon[7]); ?>"></i>
                    <div class="feature__content">
                        <h3><a href="<?php echo base_url("service/".html_escape(@$ser_slug[7])) ?>"><?php echo html_escape(@$ser_headline[7]); ?></a></h3>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr data-href="<?php echo base_url("coin-details/$symbol"); ?>" id="BGCOLOR_<?php echo html_escape($symbol); ?>">
                                            ...
                                            <td>$ <span class="price value_cap" id="PRICE_<?php echo html_escape($symbol); ?>"></span></td>
                ...
                <div class="row">
                            ...
                            ?>
                                <div class="testimonial-panel">
                                    <div class="tes-quoteInfo">
                                        <img src="<?php echo base_url(html_escape($tes_article_image)); ?>" class="quoteAvatar" alt="<?php echo strip_tags(html_escape($tes_headline)); ?>">
                                        <div>
                                            <div class="quoteAuthor"><span><?php echo html_escape($tes_headline); ?></span></div>
                    ...
                    <div class="col-sm-12">
                        <div class="client-logo">
                            ...
                            ?>
                                <div class="logo-item">
                                    <a href="<?php echo htmlspecialchars_decode($cli_article1); ?>" target="_blank"><img src="<?php echo base_url(html_escape($cli_article_image)); ?>" class="img-responsive" alt="<?php echo strip_tags(htmlspecialchars_decode($cli_headline)); ?>"></a>
                                </div>
                            <?php } ?>
                            <!-- /.End of client logo -->
                        </div>
        ...
        <div class="blog_content">
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="section_title">
                            <h3><?php echo htmlspecialchars_decode(@$hom_headline[7]); ?></h3>
                            <?php echo htmlspecialchars_decode(@$hom_article1[7]); ?>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="owl-blog owl-carousel owl-theme">
                        ...
                        ?>
                            <div class="item">
                                <div class="post_grid">
                                    <div class="grid_img">
                                        <img src="<?php echo base_url(html_escape($news_article_image)); ?>" class="img-responsive" alt="<?php echo strip_tags(html_escape($news_headline)); ?>">
                                    </div>
                                    <div class="grid_body">
                                        <h3 class="post_heading"><a href="<?php echo base_url('news/'.$cat_slug->slug."/$slug"); ?>"><?php echo html_escape($news_headline); ?></a></h3>
                                        <time datetime="<?php echo html_escape($publish_date) ?>" class="time">
                                            <?php
